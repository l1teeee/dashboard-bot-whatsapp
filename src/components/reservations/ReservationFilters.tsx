...
export function ReservationFilters({
  ...
  return (
    <section aria-label="Filtros de reservas" className="rounded-[28px] border border-ink-dark bg-mint p-4 text-ink-dark neo-shadow sm:p-5">
      <div className="flex items-center justify-between gap-3 md:hidden">
        ...
        <Button
          ...
          aria-controls="secondary-reservation-filters"
        ...
        <div className="rounded-2xl border border-ink-dark/15 bg-ink-dark/[.045] p-3 sm:p-3.5">
          <div className="flex items-center justify-between gap-3">
            ...
            <Button
              ...
              size="sm"
              onClick={() => onChange({ ...value, range: value.range === 'upcoming' ? 'all' : 'upcoming' })}
              aria-pressed={value.range === 'upcoming'}
            >
      ...
      <AnimatePresence initial={false}>
        {expanded && (
          <motion.div
            id="secondary-reservation-filters"

...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(({ className, label, error, hint, prefix, suffix, id, ...props }, ref) => {
  ...
  return <div className="space-y-1.5">
    ...
    <div className="relative">
      ...
      <input ref={ref} id={inputId} aria-invalid={Boolean(error)} aria-describedby={describedBy} className={cn('min-h-11 w-full rounded-2xl border border-border bg-surface-raised px-4 py-2 text-ink shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] transition-[border-color,box-shadow,background-color] duration-200 placeholder:text-ink-soft focus:border-brand focus:bg-surface focus:shadow-[0_0_0_4px_rgba(116,114,255,0.16)] focus:outline-none disabled:cursor-not-allowed disabled:opacity-60', prefix && 'pl-11', suffix && 'pr-12', error && 'border-coral focus:border-coral focus:shadow-[0_0_0_4px_rgba(255,104,92,0.16)]', className)} {...props} />
